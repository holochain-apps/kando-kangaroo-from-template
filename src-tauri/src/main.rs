...
const NETWORK_SEED: Option<String> = None; // KanDo (optional): You may want to put a network seed here or read it secretly from an environment variable
...
pub async fn install_app_if_necessary(
        ...
        .contains(&APP_ID.to_string())
    {
        ...
        // KanDo --- replace the path with the correct path to your .happ file here
